  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      <div className="mb-6 text-center">
        <h2 className="text-3xl font-bold text-gray-900">Criar novo post</h2>
        <p className="mt-2 text-gray-800 text-xl">Escreva sobre o que quiser e compartilhe o seu conhecimento!</p>
      </div>
        ...
        <div className="flex -mb-px">
          <button
            ...
            className={`mr-4 py-3 px-6 font-medium text-base ${
              !previewMode ? "border-b-2 border-gray-900 text-gray-900" : "text-gray-500 hover:text-gray-700"
            }`}
          >
            Editar
          </button>
      ...
      {previewMode ? (
        <div className="rounded-lg border border-gray-300 bg-white p-8 shadow-sm">
          ...
          {/* Preview Content */}
          <h1 className="mb-4 text-2xl font-bold">{title || "Título do post"}</h1>
          <div className="mb-6 whitespace-pre-wrap text-gray-700">{body || "Conteúdo do post..."}</div>

          {/* Preview Tags */}
          {tags && <div className="flex flex-wrap gap-2">{renderTagPills()}</div>}
        </div>
      ) : (
        <form
          ref={formRef}
          onSubmit={handleSubmit}
          className="space-y-6 rounded-lg border border-gray-300 bg-white p-8 shadow-sm"
        >
          {/* Error message */}
          {formError && (
            <div className="rounded-md bg-red-50 p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-red-800">Erro ao criar post</h3>
          ...
          <div>
            ...
            {image && (
              <div className="mt-2 flex items-center">
                ...
                <span className="ml-2 text-xs text-gray-500">Pré-visualização da imagem</span>
              </div>
            )}
          </div>
          ...
          <div>
            ...
            {tags && <div className="mt-2 flex flex-wrap gap-2">{renderTagPills()}</div>}
            <p className="mt-1 text-xs text-gray-500">Separe as tags por vírgulas</p>
          </div>
